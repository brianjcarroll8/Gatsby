    ...
    <Trans>
        ...
        <Columns>
          <CopyColumn>
            <p>
              ...
              tokens are intended to be used with the <code>box-shadow</code>{" "}
              CSS property.
            </p>
            <p>
              There is a lot of definition work to do here, which is why we
              deliberately chose to omit adding more documentation at this
              point.
            </p>
          </CopyColumn>
          <ContentColumn
      ...
      <Section pr={{ xxs: 0, xs: 0, sm: 0, md: 0, lg: 0 }}>
        ...
        <Columns>
          <CopyColumn>
            <p>
              Intended for use with the <code>letter-spacing</code> CSS
              property.
            </p>
          </CopyColumn>
          <ContentColumn fullWidth>
      ...
      <Section>
        ...
        <Columns>
          <CopyColumn>
            <p>
              For convenience, a <code>mediaQueries</code> scale derived from
              the
              {` `}
