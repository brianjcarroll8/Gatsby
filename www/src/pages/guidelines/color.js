          ...
          <Section>
            <Columns>
              <CopyColumn sticky={false}>
                <Text as="p" mb={0}>
                  Our color palette includes primary and secondary colors that
                  can be used for interfaces as well as illustrations.
                  <br />
                  <strong>
            ...
            <Columns>
              <CopyColumn>
                <p>
                  ...
                  {` `}
                  Level AA standard contrast ratios. To do this, we need to
                  choose primary, secondary and neutral colors that support
                  usability. This ensures sufficient color contrast between
                  elements so that users with low vision can see and use our
                  products.
                </p>
              </CopyColumn>
              <ContentColumn>
                ...
                <p>
                  ...
                  values. It outputs a number between 0 and 21, with 21 being
                  the highest amount of contrast—think black text and a white
                  background—and 0 being no contrast—white on white. That ratio
                  is where the scores are derived from. There are technically 5
                  scores:
                </p>
                <ul css={{ padding: 0 }}>
                  <li>
                  ...
                  <li>
                    ...
                    14pt bold/18pt (which roughly translates to ~18.5px
                    bold/24px @1x) and larger.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    ratio of
                    <code>4.5</code> or higher—which is the same score as AA,
                    and which is why you won't see AAA Large as a visible score
                ...
                <p>
                  ...
                  analyzer to confirm your choices. Here are a couple of free
                  apps and browser extensions to help:
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    <a href="https://colororacle.org/index.html">
                      Color Oracle
                    </a>
                    {` `}
