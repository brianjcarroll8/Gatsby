    ...
    <Trans>
        ...
        <Columns>
          <CopyColumn>
            ...
            <p>
              ...
              device; depending on that, we use San Francisco UI, Roboto or
              Segoe UI.
            </p>
            <Text as="p">
              Our monospace font stack also makes use of the default fonts
              available: That’s usually San Francisco Mono, Menlo or Monaco on
              Mac OS X, Consolas on Windows, or Liberation Sans on Linux
              distributions.
            </Text>
            <Text as="p" mb={0}>
      ...
      <Section pr={{ xxs: 0, xs: 0, sm: 0, md: 0, lg: 0 }}>
        ...
        <Columns>
          <CopyColumn>
            <p>
              Since our primary use for the design system is interface design,
              our typographic scale is hand-crafted. This way we don’t have to
              worry about decimals in our design tools or when calculating line
              heights, don’t have to worry about subpixel rounding errors, and
              have total control over which sizes exist instead of outsourcing
              that job to a mathematical formula.
            </p>
            <Text as="p" mb={0}>
              For long form content like articles, using a modular scale is
              totally fine though. Typography.js makes setting up and using such
              a scale easy.
            </Text>
          </CopyColumn>
            ...
            {fontSizes.map((size, index) => (
              <div key={`${index}-${size}`}>
                ...
                <Box
                  ...
                  color="textMuted"
                >
                  <strong>{parseFloat(size) * 16}</strong>&nbsp;&nbsp;&nbsp;
                  {size}
                  &nbsp;&nbsp;&nbsp;
                  <code
                    css={{
          ...
          <ContentColumn>
            ...
            <Flex flexWrap="wrap" flexDirection="row">
              ...
              <Box maxWidth={{ xl: `40%` }}>
                ...
                <Box pb={4}>
                  ...
                  <Text as="p" pt={4}>
                    Use this for the all headlines but the main page title, and
                    to emphasize text throughout regular copy.
                  </Text>
                </Box>
              </Box>
              <Box>
            ...
            <ExampleBox>
              ...
              <Intro lineHeight="loose" pb={8} pt={4} mb={0}>
                ...
                everyone, with helpful defaults that bake in web accessibility
        ...
        <Columns>
          <CopyColumn>
            <p>
              ...
              components used on our website. Ideally, this section will be
              built using these "live" components.
            </p>
          </CopyColumn>
          <ContentColumn>
            <Box maxWidth="35rem">
              ...
              <Text fontSize={{ xxs: 2, md: 3 }} mb={7}>
                <p>
                  ...
                  created tools that allow developers to build quicker with
                  fewer bugs. Gatsby gives you easy access to features like
                  modern JavaScript syntax, code bundling and hot reloading,
                ...
                <p>
                  ...
                  budgets, interactivity requirements and content systems can
                  vary wildly from one project to the next.
                </p>
                <p>
                  This variety puts website teams between a rock and a hard
                  place. They often have to maintain frontends built in multiple
                  development systems, stretching their developers’ skill sets.
                  Implementing the same dropdown in five different frameworks
                  can be a huge headache. But what’s the alternative — turn down
                  good client projects?
                </p>
                <p>
                  To add to the difficulty, when your UI development framework
                  is coupled to your client’s CMS backend, it doesn’t just cause
        ...
        <Flex as="section" py={4} my={4}>
          <Box mt={8} mr="auto" pr={7} display={{ xxs: `none`, md: `block` }}>
            ...
            >
              ...
              <SidebarUL>
                {[`Introduction`, `Quickstart`, `Recipes`].map(
                  (item, index) => (
                    <SidebarLI key={`sidebar-item-1-${index}`}>
                      {item}
                    </SidebarLI>
                  )
                )}
          ...
          <Box maxWidth="48rem" mx="auto" css={{ minWidth: `0` }}>
            ...
            >
              ...
              <p>
                ...
                removing the need for a lot of boilerplate associated with
                classes in JavaScript (looking at you, <code>this</code>), they
                enable some serious shareability. They also make it possible to
              ...
              <p>
                ...
                modern web out of the box, from implementing a Progressive Web
                App (PWA) checklist of features, React, accessibility by
                default, CSS-in-JS support, headless CMSs, and GraphQL.
              </p>
              <p>
                <strong>
              ...
              >
                ...
                {` `}
                for Mac and Linux users, and this tutorial for Windows users.
                Even if you are a Windows user, the first page of the Codecademy
